...
const Aboutus = () => {
  return (
    <div className="flex flex-col justify-center items-center mt-10 ">
      <div className="w-2/6 text-center mb-5">
        <p className="text-sm py-3 text-customGreen">About Us</p>
        <h3 className="text-2xl font-semibold">
          We provide great services for our customers based on needs
        </h3>
      </div>
      <div className="flex justify-center items-center gap-32 text-gray-800 font-light text-sm my-5">
        <div className="w-1/4">
      ...
      <div className="flex flex-row-reverse justify-center items-center gap-32 text-gray-800 font-light text-sm my-5">
        <div className="w-1/4">
          ...
          <button className="bg-gradient-tob2 text-gray-500 px-3 py-2 my-5 rounded-md">Learn more</button>
        </div>
        <div>
